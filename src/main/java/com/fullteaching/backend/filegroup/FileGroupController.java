...
public class FileGroupController {
	...
	public ResponseEntity<Object> deleteFileGroup(
		...
		try {
			...
			log.error("com.fullteaching.backend.Course ID '{}' or FileGroup ID '{}' are not of type Long", courseId, fileGroupId);
			return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
		}
	...
	public ResponseEntity<Object> editFileOrder(
		...
		try{
			...
			log.error("com.fullteaching.backend.Course ID '{}' or File ID '{}' or source ID '{}' or target ID '{}' are not of type Long; or position is not of type Integer",
	...
	public ResponseEntity<Object> deleteFile(
		...
		try {
			...
			log.error("com.fullteaching.backend.Course ID '{}' or FileGroup ID '{}' or File ID '{}' are not of type Long", courseId, fileGroupId, fileId);
			return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
		}
