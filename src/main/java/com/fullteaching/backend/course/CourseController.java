...
public class CourseController {
	...
	public ResponseEntity<Object> getCourses(@PathVariable(value="id") String id) {
		...
		try{
			...
			log.error("com.fullteaching.backend.User ID '{}' is not of type Long", id);
	...
	public ResponseEntity<Object> getCourse(@PathVariable(value="id") String id) {
		...
		try{
			...
			log.error("com.fullteaching.backend.Course ID '{}' is not of type Long", id);
			return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
		}
	...
	public ResponseEntity<Object> newCourse(@RequestBody Course course) {
		...
		/*Saving the new course: com.fullteaching.backend.Course entity is the owner of the relationships
		com.fullteaching.backend.Course-Teacher, com.fullteaching.backend.Course-com.fullteaching.backend.User, com.fullteaching.backend.Course-CourseDetails. Teacher, com.fullteaching.backend.User and CourseDetails
	...
	public ResponseEntity<Object> modifyCourse(@RequestBody Course course) {
		...
		if (teacherAuthorized != null) { // If the user is not the teacher of the course
			...
			log.info("com.fullteaching.backend.Course succesfully updated. Modified value: {}", c.toString());
	...
	public ResponseEntity<Object> deleteCourse(@PathVariable(value="courseId") String courseId) {
		...
		try{
			...
			log.error("com.fullteaching.backend.Course ID '{}' is not of type Long", courseId);
			return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
		}
		...
		if (teacherAuthorized != null) { // If the user is not the teacher of the course
			...
			log.info("com.fullteaching.backend.Course successfully deleted");
			...
			@PathVariable(value="courseId") String courseId) 
	{
		...
		if (teacherAuthorized != null) { // If the user is not the teacher of the course
			...
			//Saving the attenders (all of them, just in case a field of the bidirectional relationship is missing in a com.fullteaching.backend.Course or a com.fullteaching.backend.User)
	...
	//Checks if a com.fullteaching.backend.User collection contains a user with certain email
